...
@section('title', 'Əlaqə - MODERN LEASING')
@section('description', 'Modern Leasing ilə əlaqə saxlayın. Ünvan, telefon, email məlumatları və müraciət formu. Bizim ofisimizdə ziyarət edin və ya online əlaqə quruj.')
@section('keywords', 'əlaqə, telefon, email, ünvan, müraciət formu, iş saatları, modern leasing')
