...
<section class="hero-section" id="heroSection">
                    ...
                    <div class="hero-stats mt-5" data-aos="fade-up" data-aos-delay="900">
                        <div class="row">
                            <div class="col-md-3 col-6 mb-3">
                                <div class="stat-item">
                                    <div class="stat-number animate-number" data-count="3500">0</div>
                                    <div class="stat-label">Məmnun Müştəri</div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-3">
                                <div class="stat-item">
                                    <div class="stat-number animate-number" data-count="6800">0</div>
                                    <div class="stat-label">Təhvil Verilən Texnika</div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-3">
                                <div class="stat-item">
                                    <div class="stat-number animate-number" data-count="25">0</div>
                                    <div class="stat-label">Beynəlxalq Tərəfdaş</div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-3">
                                <div class="stat-item">
                                    <div class="stat-number animate-number" data-count="15">0</div>
    ...
    <!-- Slide navigation (like in the image) -->
    <div class="slide-navigation d-none d-lg-flex" data-aos="fade-right" data-aos-delay="1000">
        <div class="slide-nav-item active">
