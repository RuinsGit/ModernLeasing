...
@section('title', 'Xidmət Redaktə Et - İdarə Paneli')
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Xidmət haqqında qısa təsvir yazın...">{{ old('description', $service->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-3" id="icon-preview">
                                            ...
                                            <div class="p-3 border rounded text-center">
                                                <i id="icon-preview-element" class="{{ $service->icon_class }} text-primary" style="font-size: 2rem;"></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="preview-card" style="background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 20px; max-width: 400px;">
                                            <div class="text-center">
                                                <div class="mb-3">
                                                    <i id="preview-icon" class="{{ $service->icon_class }} text-primary" style="font-size: 3rem;"></i>
                                                </div>
                                                <h5 id="preview-title" class="text-dark">{{ $service->title }}</h5>
                                                <p id="preview-description" class="text-muted" style="font-size: 0.9rem;">{{ $service->description }}</p>
