...
@section('title', 'Xidmətlər - İdarə Paneli')
                                ...
                                <tbody>
                                    @forelse($services as $service)
                                        <tr>
                                            <td>
                                                <div class="form-check font-size-16">
                                                    <input class="form-check-input" type="checkbox" id="servicecheck{{ $service->id }}">
                                                    <label class="form-check-label" for="servicecheck{{ $service->id }}"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-soft-primary text-primary rounded" 
                                                        ...
                                                        <i class="{{ $service->icon_class }} font-size-18"></i>
                                                    </span>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @if($service->features_list && count($service->features_list) > 0)
                                                    <small class="text-info">
                                                        ...
                                                        {{ count($service->features_list) }} xüsusiyyət
                                                    </small>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <form action="{{ route('admin.services.toggle-status', $service->id) }}" method="POST" class="d-inline-block">
                                                    @csrf
                                            ...
                                            <td>
                                                <div class="d-flex gap-3">
                                                    <!-- <a href="{{ route('admin.services.show', $service->id) }}" class="text-info">
                                                        <i class="mdi mdi-eye font-size-18"></i>
                                                    </a> -->
                                                    <a href="{{ route('admin.services.edit', $service->id) }}" class="text-success">
                                                        <i class="mdi mdi-pencil font-size-18"></i>
                                                    </a>
                                                    <form id="delete-form-{{ $service->id }}" action="{{ route('admin.services.destroy', $service->id) }}" method="POST" class="d-inline-block">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-link text-danger p-0" onclick="deleteData({{ $service->id }})">
