...
@section('title', 'Şirkət Tarixi Elementini Redaktə Et - İdarə Paneli')
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.company-history-items.update', $companyHistoryItem->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" class="form-control @error('year') is-invalid @enderror" 
                                               id="year" name="year" value="{{ old('year', $companyHistoryItem->year) }}" 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                               id="title" name="title" value="{{ old('title', $companyHistoryItem->title) }}" 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('icon_class') is-invalid @enderror" 
                                               id="icon_class" name="icon_class" value="{{ old('icon_class', $companyHistoryItem->icon_class) }}" 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                               id="order" name="order" value="{{ old('order', $companyHistoryItem->order) }}" 
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Zaman xətti elementi haqqında qısa təsvir...">{{ old('description', $companyHistoryItem->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" {{ old('is_active', $companyHistoryItem->is_active) ? 'checked' : '' }}>
