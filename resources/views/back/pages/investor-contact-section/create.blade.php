...
@section('title', 'Yeni İnvestor Əlaqə Bölməsi Yarat - İdarə Paneli')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Yeni İnvestor Əlaqə Bölməsi Yarat</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Yeni İnvestor Əlaqə Bölməsi Məlumatları</h4>
                        <p class="card-title-desc">İnvestor səhifəsindəki əlaqə bölməsinin məlumatlarını daxil edin.</p>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.investor-contact-section.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('button1_text') is-invalid @enderror" 
                                               id="button1_text" name="button1_text" value="{{ old('button1_text', 'Əlaqə Saxlayın') }}" 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('button1_link') is-invalid @enderror" 
                                               id="button1_link" name="button1_link" value="{{ old('button1_link', route('front.contact')) }}" 
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                               id="email" name="email" value="{{ old('email', 'investor@modernlizinq.az') }}" 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('button2_text') is-invalid @enderror" 
                                               id="button2_text" name="button2_text" value="{{ old('button2_text', '+994 12 345 67 89') }}" 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('button2_link') is-invalid @enderror" 
                                               id="button2_link" name="button2_link" value="{{ old('button2_link', 'tel:+994123456789') }}" 
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('subtitle') is-invalid @enderror" 
                                          ...
                                          placeholder="Bölmənin alt başlığını daxil edin...">{{ old('subtitle', 'Lizinq sahəsində böyümə imkanlarından faydalanmaq və uğurlu tərəfdaşlıq qurmaq üçün bizimlə əlaqə saxlayın. Mütəxəssis komandamız sizə ən uyğun əməkdaşlıq modelini təklif edəcək.') }}</textarea>
                                @error('subtitle')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-plus me-2"></i> Bölməni Yarat
                                </button>
