...
@section('title', 'Yeni Missiya/Məqsəd Əlavə Et - İdarə Paneli')
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.mission-goals.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Missiya/Məqsəd haqqında qısa təsvir yazın...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
