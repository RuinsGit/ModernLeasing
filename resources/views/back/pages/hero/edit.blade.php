...
@section('title', 'Hero Section Redaktə Et - İdarə Paneli')
                        ...
                        <form action="{{ route('admin.hero.update', $hero->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('subtitle') is-invalid @enderror" 
                                          ...
                                          placeholder="Alt başlığı daxil edin (məcburi deyil)">{{ old('subtitle', $hero->subtitle) }}</textarea>
                                @error('subtitle')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('happy_customers') is-invalid @enderror" 
                                               ...
                                               value="{{ old('happy_customers', $hero->happy_customers) }}" min="0"
                                               placeholder="3500">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('delivered_equipment') is-invalid @enderror" 
                                               ...
                                               value="{{ old('delivered_equipment', $hero->delivered_equipment) }}" min="0"
                                               placeholder="6800">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('international_partners') is-invalid @enderror" 
                                               ...
                                               value="{{ old('international_partners', $hero->international_partners) }}" min="0"
                                               placeholder="25">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('years_experience') is-invalid @enderror" 
                                               ...
                                               value="{{ old('years_experience', $hero->years_experience) }}" min="0"
                                               placeholder="15">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.hero.show', $hero->id) }}" class="btn btn-info">
                                    <i class="mdi mdi-eye me-2"></i> Bax
                                </a>
                            </div>
                        </form>
                    </div>
