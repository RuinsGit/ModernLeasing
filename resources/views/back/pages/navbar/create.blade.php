...
@section('title', 'Yeni Navbar Menyu - İdarə Paneli')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Yeni Navbar Menyu</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Yeni Navbar Menyu Əlavə Et</h4>
                        <p class="card-title-desc">Navbar'da göstəriləcək menyu elementini yaradın</p>
                    </div>
                    <div class="card-body">
