...
@section('title', 'Komanda Üzvləri - İdarə Paneli')
                                    ...
                                    <tbody>
                                        @foreach($teamMembers as $member)
                                            <tr>
                                                ...
                                                <td>{{ $member->order }}</td>
                                                <td>
                                                    <form action="{{ route('admin.team-members.toggle-status', $member->id) }}" method="POST" class="d-inline-block">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-{{ $member->is_active ? 'success' : 'danger' }}">
