                                    ...
                                    <tbody>
                                        @foreach($newsItems as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.news-items.show', $item->id) }}" class="btn btn-info btn-sm"><i class="mdi mdi-eye"></i></a>
                                                    <a href="{{ route('admin.news-items.edit', $item->id) }}" class="btn btn-primary btn-sm"><i class="mdi mdi-pencil"></i></a>
