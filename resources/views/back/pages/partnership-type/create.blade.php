...
@section('title', 'Yeni Tərəfdaşlıq Növü Əlavə Et - İdarə Paneli')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Yeni Tərəfdaşlıq Növü Əlavə Et</h4>
                        <p class="card-title-desc">İnvestorlar səhifəsində göstəriləcək yeni tərəfdaşlıq növünü əlavə edin.</p>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.partnership-types.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('icon_class') is-invalid @enderror" 
                                               id="icon_class" name="icon_class" value="{{ old('icon_class', 'fas fa-question-circle') }}" 
                                        ...
                                        <div class="mt-2">
                                            <i id="icon-preview" class="font-size-24 text-primary"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Tərəfdaşlıq növü haqqında qısa təsvir yazın...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bx bx-plus me-2"></i> Tərəfdaşlıq Növünü Əlavə Et
                                </button>
