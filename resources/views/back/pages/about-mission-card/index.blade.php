                                    ...
                                    <tbody>
                                        @foreach($missionCards as $card)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.about-mission-card.show', $card->id) }}" class="btn btn-info btn-sm"><i class="mdi mdi-eye"></i></a>
                                                    <a href="{{ route('admin.about-mission-card.edit', $card->id) }}" class="btn btn-primary btn-sm"><i class="mdi mdi-pencil"></i></a>
