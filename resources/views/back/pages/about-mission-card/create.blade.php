...
@section('title', 'Yeni Haqqımızda Missiya Kartı Yarat - İdarə Paneli')
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.about-mission-card.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('icon_class') is-invalid @enderror" 
                                               id="icon_class" name="icon_class" value="{{ old('icon_class', 'fas fa-bullseye') }}" 
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Kart haqqında qısa təsvir...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
