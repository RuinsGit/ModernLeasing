...
@section('title', 'Yeni Əlaqə Məlumatı Əlavə Et - İdarə Paneli')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Yeni Əlaqə Məlumatı Əlavə Et</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.contact-info.index') }}">Əlaqə Məlumatları</a></li>
                            <li class="breadcrumb-item active">Yeni Məlumat</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Yeni Əlaqə Məlumatı Əlavə Et</h4>
                        <p class="card-title-desc">Saytın əlaqə məlumatlarını daxil edin (footer və əlaqə səhifəsi üçün)</p>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.contact-info.store') }}" method="POST">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="email" class="form-control @error('email1') is-invalid @enderror" 
                                               id="email1" name="email1" value="{{ old('email1') }}" 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="email" class="form-control @error('email2') is-invalid @enderror" 
                                               id="email2" name="email2" value="{{ old('email2') }}" 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('working_hours_weekdays') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Məsələn: Bazar ertəsi - Cümə: 09:00 - 18:00">{{ old('working_hours_weekdays') }}</textarea>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('working_hours_weekends') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Məsələn: Şənbə: 09:00 - 14:00, Bazar: Bağlı">{{ old('working_hours_weekends') }}</textarea>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('map_iframe') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Google Xəritədən əldə etdiyiniz iframe kodunu bura yapışdırın.">{{ old('map_iframe') }}</textarea>
                                        @error('map_iframe')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bx bx-plus me-2"></i> Əlaqə Məlumatı Əlavə Et
                                </button>
