...
<?php $__env->startSection('title', 'Yeni FAQ Sualı Yarat - İdarə Paneli'); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Yeni FAQ Sualı Yarat</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Yeni FAQ Sualı Məlumatları</h4>
                        <p class="card-title-desc">Yeni FAQ sualı və cavabı üçün məlumatları daxil edin.</p>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.faq-items.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="faq_category_id" name="faq_category_id">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->id); ?>" <?php echo e(old('faq_category_id') == $category->id ? 'selected' : ''); ?>><?php echo e($category->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-plus me-2"></i> Sualı Yarat
                                </button>
...
<?php echo $__env->make('back.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ModernLeasing\resources\views/back/pages/faq-item/create.blade.php ENDPATH**/ ?>