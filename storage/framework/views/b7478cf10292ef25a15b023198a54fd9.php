...
<?php $__env->startSection('title', 'Yeni Xəbər Yarat - İdarə Paneli'); ?>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.news-items.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="news_date" name="news_date" value="<?php echo e(old('news_date', date('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="Xəbər haqqında qısa məlumat..."><?php echo e(old('short_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="Xəbər haqqında tam məlumat..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('back.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ModernLeasing\resources\views/back/pages/news-item/create.blade.php ENDPATH**/ ?>