            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="advantages-content">
                        <?php if(isset($advantages) && $advantages->count() > 0): ?>
                            <?php $__currentLoopData = $advantages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $advantage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="advantage-item" data-aos="fade-up" data-aos-delay="<?php echo e(300 + ($index * 100)); ?>" data-image-url="<?php echo e($advantage->image_url); ?>">
                                    <div class="advantage-icon">
                                        <i class="<?php echo e($advantage->icon_class); ?>"></i>
                                    </div>
                                    <div class="advantage-content">
                                        <h4 class="text-white"><?php echo e($advantage->title); ?></h4>
                                        <p class="text-light"><?php echo e($advantage->description); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
            ...
            <div class="row g-5 align-items-center flex-row-reverse"> 
                <div class="col-lg-6" data-aos="fade-left"> 
                    <div class="mission-content">
                        ...
                        <?php if(isset($missionGoals) && $missionGoals->count() > 0): ?>
                            <?php $__currentLoopData = $missionGoals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $missionGoal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mission-item" data-aos="fade-up" data-aos-delay="<?php echo e(300 + ($index * 100)); ?>" data-image-url="<?php echo e($missionGoal->image_url); ?>"> 
                                    <div class="mission-icon">
                                        <i class="<?php echo e($missionGoal->icon_class); ?>"></i>
                                    </div>
                                    <div class="mission-text">
                                        <h4 class="text-white"><?php echo e($missionGoal->title); ?></h4>
                                        <p class="text-light"><?php echo e($missionGoal->description); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <!-- Default static mission goals if no data -->
                            <div class="mission-item" data-aos="fade-up" data-aos-delay="300" data-image-url="https://images.unsplash.com/photo-1521737711867-e3b97375f902?ixlib=rb-4.0.3&auto=format&fit=crop&w=1740&q=80"> 
                                <div class="mission-icon">
                            ...
                            <div class="mission-item" data-aos="fade-up" data-aos-delay="400" data-image-url="https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1740&q=80"> 
                                <div class="mission-icon">
                            ...
                            <div class="mission-item" data-aos="fade-up" data-aos-delay="500" data-image-url="https://images.unsplash.com/photo-1552588147-3211516631b6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1740&q=80"> 
                                <div class="mission-icon">
                ...
                <div class="col-lg-6" data-aos="fade-right"> 
                    <div class="mission-image">
                        <img id="mission-display-image" src="<?php echo e(isset($missionGoals) && $missionGoals->count() > 0 ? ($missionGoals->first()->image_url ?: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?ixlib=rb-4.0.3&auto=format&fit=crop&w=1740&q=80') : 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?ixlib=rb-4.0.3&auto=format&fit=crop&w=1740&q=80'); ?>" 
                             alt="Bizim Missiyamız" class="img-fluid" style="border-radius: 8px; width: 100%; height: 400px; object-fit: cover;"> 
    ...
    <section class="stats-section section-padding bg-primary text-white">
        <div class="container">
            <div class="row text-center">
                <?php if(isset($statItems) && $statItems->count() > 0): ?>
                    <?php $__currentLoopData = $statItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $statItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="<?php echo e(100 + ($index * 100)); ?>">
                            <div class="stat-box">
                                <div class="stat-icon">
                                    <i class="<?php echo e($statItem->icon_class); ?>"></i>
                                </div>
                                <h3 class="animate-number" data-count="<?php echo e($statItem->value); ?>">0</h3>
                                <p><?php echo e($statItem->title); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
