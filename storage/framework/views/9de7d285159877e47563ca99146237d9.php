...
<?php $__env->startSection('title', 'Yeni Missiya/Məqsəd Əlavə Et - İdarə Paneli'); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Yeni Missiya/Məqsəd Əlavə Et</h4>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Yeni Missiya/Məqsəd</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Yeni Missiya/Məqsəd Əlavə Et</h4>
                        <p class="card-title-desc">Ana səhifədə göstəriləcək Missiya/Məqsəd məlumatlarını daxil edin</p>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.mission-goals.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  placeholder="Missiya/Məqsəd haqqında qısa təsvir yazın..."><?php echo e(old('description')); ?></textarea>
                                        ...
                                        <div class="preview-card" style="background: #1F1F1F; border: 1px solid #333; border-radius: 8px; padding: 20px; max-width: 500px;">
                                            <div class="d-flex align-items-start">
                                                <div class="mission-icon me-3" style="width: 50px; height: 50px; background: #2289FF; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                                    <i id="preview-icon" class="fas fa-question text-white" style="font-size: 1.2rem;"></i>
                                                </div>
                                                <div class="mission-content flex-grow-1">
                                                    <h5 id="preview-title" class="text-white mb-2">Başlıq</h5>
                                                    <p id="preview-description" class="text-light mb-0" style="font-size: 0.9rem;">Təsvir...</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-2">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-plus me-2"></i> Missiya/Məqsəd Əlavə Et
                                        </button>
...
<?php echo $__env->make('back.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ModernLeasing\resources\views/back/pages/mission-goals/create.blade.php ENDPATH**/ ?>